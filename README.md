...
<html>
    ...
    <body>
        ...
        <div class="Week1">
            ...
            <li>Day 7: Rest.</li>
            <h3 style="color: green">WEEK GOAL AND (SHIP THIS WEEK): 3 small responsive pages (a personal landing page, a pricing page clone from scratch, a restaurant menu page) — all pushed to GitHub, deployed to GitHub Pages.</h3>
        </div>
    </body>
</html>
